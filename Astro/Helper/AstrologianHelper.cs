...
public static class AstrologianHelper
{
    ...
    private static string Debuff =>
        DalamudApi.ClientState.ClientLanguage == ClientLanguage.Japanese ? "ダメージ低下" : "Damage Down";
    ...
    {
        { ArcanumType.Melee, new List<string> { "DRG", "SAM", "NIN", "MNK", "RPR", "DRK", "GNB", "WAR", "PLD", "GLA", "MRD" } },
        { ArcanumType.Range, new List<string> { "BLM", "SMN", "MCH", "BRD", "RDM", "DNC", "BLU", "SGE", "ARC", "WHM", "SCH", "AST", "CNJ" } }
    };
